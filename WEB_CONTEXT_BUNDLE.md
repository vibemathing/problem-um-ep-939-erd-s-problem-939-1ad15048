...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-939-erd-s-problem-939-1ad15048-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-939"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-939-erd-s-problem-939-1ad15048-v1",
      "problem_contract_sha256": "8f5753b2ca4c28231975ab445d6292cd664d3aaffb57530b98c1aa3ae646c982",
      "problem_id": "problem:um-ep-939-erd-s-problem-939-1ad15048",
      "route_id": "route:um-ep-939-erd-s-problem-939-1ad15048-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-939-erd-s-problem-939-1ad15048-source-fidelity-01",
      "graph_id": "graph:um-ep-939-erd-s-problem-939-1ad15048-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-939-erd-s-problem-939-1ad15048-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-939-erd-s-problem-939-1ad15048-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $r\\geq 2$. An $r$-powerful number $n$ is one such that if $p\\mid n$ then $p^r\\mid n$. If $r\\geq 4$ then can the sum of $r-2$ coprime $r$-powerful numbers ever be itself $r$-powerful? Are there at most finitely many such solutions? Are there infinitely many triples of coprime $3$-powerful numbers $a,b,c$ such that $a+b=c$?"
          },
          "statement_sha256": "f62d0f1e7b6860d194a20e56b794fc4694ff2bcdcc456aa07984077f7f0d044c"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-939-erd-s-problem-939-1ad15048-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-939-erd-s-problem-939-1ad15048-root",
      "route_id": "route:um-ep-939-erd-s-problem-939-1ad15048-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-939-20f235b72cac",
        "url": "https://www.unsolvedmath.com/problems/EP-939"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
